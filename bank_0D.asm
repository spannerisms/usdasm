...
.message_low
#_0DC513: db $2C ; MESSAGE 012C
#_0DC514: db $2D ; MESSAGE 012D
#_0DC515: db $2E ; MESSAGE 012E
#_0DC516: db $2D ; MESSAGE 012D
...
.rejected
#_0DC818: LDA.b #$F5 ; MESSAGE 00F5
#_0DC81A: LDY.b #$00
#_0DC81C: JSL Sprite_ShowMessageUnconditional

#_0DC820: LDA.b #$02
#_0DC822: STA.w $0D80,X
...
.rejected
#_0DCA0C: LDA.b #$F5 ; MESSAGE 00F5
#_0DCA0E: LDY.b #$00
#_0DCA10: JSL Sprite_ShowMessageUnconditional

#_0DCA14: LDA.b #$02
#_0DCA16: STA.w $0D80,X
...
.oam_groups
#_0DCAA1: dw   0, -48 : db $0C, $00, $00, $02
#_0DCAA9: dw   0, -32 : db $2C, $00, $00, $00
#_0DCAB1: dw   8, -32 : db $2C, $40, $00, $00

#_0DCAB9: dw   0, -48 : db $0A, $00, $00, $02
#_0DCAC1: dw   0, -32 : db $2A, $00, $00, $00
#_0DCAC9: dw   8, -32 : db $2A, $40, $00, $00

#_0DCAD1: dw  -4, -40 : db $66, $00, $00, $02
#_0DCAD9: dw   4, -40 : db $66, $40, $00, $02
#_0DCAE1: dw  -4, -40 : db $66, $00, $00, $02

#_0DCAE9: dw  -4, -40 : db $68, $00, $00, $02
#_0DCAF1: dw   4, -40 : db $68, $40, $00, $02
#_0DCAF9: dw  -4, -40 : db $68, $00, $00, $02
...
.main
#_0DCB5C: JSL SpriteDraw_RaceGameLady

#_0DCB60: JSR Sprite_CheckIfActive_Bank0D

#_0DCB63: JSL Sprite_TrackBodyToHead
#_0DCB67: JSL Sprite_DirectionToFaceLink_long

#_0DCB6B: TYA
#_0DCB6C: EOR.b #$03
#_0DCB6E: STA.w $0EB0,X

#_0DCB71: LDA.w $0D80,X
#_0DCB74: JSL JumpTableLocal
#_0DCB78: dw RaceGameLady_Idle
#_0DCB7A: dw RaceGameLady_FireStarterPistol
#_0DCB7C: dw RaceGameLady_TimeRun
...
.cheater
#_0DCBB1: LDA.b #$D0 ; MESSAGE 00D0
#_0DCBB3: LDY.b #$00
#_0DCBB5: JSL Sprite_ShowMessageOnContact
...
.main
#_0DCBF2: JSL SpriteDraw_YoungGameGuy
#_0DCBF6: JSR Sprite_CheckIfActive_Bank0D
#_0DCBF9: JSL Sprite_TrackBodyToHead

#_0DCBFD: STZ.w $0EB0,X

#_0DCC00: JSL Sprite_BehaveAsBarrier
...
#_0DCC08: LSR A
#_0DCC09: AND.b #$01
#_0DCC0B: STA.w $0DC0,X

#_0DCC0E: LDA.w $0ABF
#_0DCC11: BNE .disqualify_cheater

#_0DCC13: LDA.w $0D80,X
#_0DCC16: JSL JumpTableLocal
#_0DCC1A: dw RaceGameGuy_VerifyRun
#_0DCC1C: dw RaceGameGuy_MakeModDecision
#_0DCC1E: dw RaceGameGuy_RejectRun
#_0DCC20: dw RaceGameGuy_AcceptRun
#_0DCC22: dw RaceGameGuy_IdleInDiscord

;---------------------------------------------------------------------------------------------------

.disqualify_cheater
#_0DCC24: LDA.b #$D0 ; MESSAGE 00D0
#_0DCC26: LDY.b #$00
#_0DCC28: JSL Sprite_ShowMessageOnContact
...
.prize_available
#_0DCCC5: LDA.l $7FFE05
#_0DCCC9: BNE .run_doesnt_belong_on_boards

#_0DCCCB: LDA.l $7FFE04
#_0DCCCF: CMP.b #$10
#_0DCCD1: BCS .run_doesnt_belong_on_boards

;---------------------------------------------------------------------------------------------------

.gg
#_0DCCD3: INC.w $0D80,X

#_0DCCD6: LDA.b #$CD ; MESSAGE 00CD
#_0DCCD8: LDY.b #$00
#_0DCCDA: JSL Sprite_ShowMessageUnconditional

#_0DCCDE: STA.w $0EB0,X
#_0DCCE1: STA.w $0DE0,X
...
#_0DCCE5: LDA.b #$CE ; MESSAGE 00CE
#_0DCCE7: LDY.b #$00
#_0DCCE9: JSL Sprite_ShowMessageUnconditional

#_0DCCED: STA.w $0EB0,X
#_0DCCF0: STA.w $0DE0,X
...
#_0DCDD7: dw   1,   3 : db $22, $01, $00, $02

#_0DCDDF: dw   1,  -7 : db $20, $01, $00, $02
#_0DCDE7: dw   1,   3 : db $22, $41, $00, $02

#_0DCDEF: dw   1,  -7 : db $20, $01, $00, $02
#_0DCDF7: dw   1,   3 : db $22, $01, $00, $02

#_0DCDFF: dw   1,  -7 : db $20, $01, $00, $02
#_0DCE07: dw   1,   3 : db $22, $41, $00, $02

#_0DCE0F: dw   1,  -7 : db $20, $01, $00, $02
#_0DCE17: dw   1,   3 : db $22, $01, $00, $02

#_0DCE1F: dw   1,  -7 : db $20, $01, $00, $02
#_0DCE27: dw   1,   3 : db $22, $01, $00, $02

#_0DCE2F: dw   1,  -7 : db $20, $41, $00, $02
#_0DCE37: dw   1,   3 : db $22, $41, $00, $02

#_0DCE3F: dw   1,  -7 : db $20, $41, $00, $02
#_0DCE47: dw   1,   3 : db $22, $41, $00, $02
...
#_0DCE99: dw   0,   0 : db $26, $0E, $00, $02

#_0DCEA1: dw   0,  -8 : db $20, $0E, $00, $02
#_0DCEA9: dw   0,   0 : db $26, $4E, $00, $02

#_0DCEB1: dw   0,  -8 : db $0E, $0E, $00, $02
#_0DCEB9: dw   0,   0 : db $24, $0E, $00, $02

#_0DCEC1: dw   0,  -8 : db $0E, $0E, $00, $02
#_0DCEC9: dw   0,   0 : db $24, $0E, $00, $02

#_0DCED1: dw   0,  -8 : db $22, $0E, $00, $02
#_0DCED9: dw   0,   0 : db $28, $0E, $00, $02

#_0DCEE1: dw   0,  -8 : db $22, $0E, $00, $02
#_0DCEE9: dw   0,   0 : db $2A, $0E, $00, $02

#_0DCEF1: dw   0,  -8 : db $22, $4E, $00, $02
#_0DCEF9: dw   0,   0 : db $28, $4E, $00, $02

#_0DCF01: dw   0,  -8 : db $22, $4E, $00, $02
#_0DCF09: dw   0,   0 : db $2A, $4E, $00, $02

#_0DCF11: dw  -7,   1 : db $0A, $0E, $00, $02
#_0DCF19: dw   3,   3 : db $0C, $0E, $00, $02

#_0DCF21: dw  -7,   1 : db $0A, $0E, $00, $02
#_0DCF29: dw   3,   3 : db $0C, $0E, $00, $02
...
.oam_groups
#_0DCF59: dw  -1,  -1 : db $BE, $0A, $00, $00
#_0DCF61: dw   0,   0 : db $AA, $0A, $00, $02
#_0DCF69: dw   0, -10 : db $A8, $0A, $00, $02
#_0DCF71: dw   0,   0 : db $AA, $0A, $00, $02

#_0DCF79: dw  -1,  -1 : db $BE, $0A, $00, $00
#_0DCF81: dw   0,   8 : db $BF, $0A, $00, $00
#_0DCF89: dw   0, -10 : db $A8, $0A, $00, $02
#_0DCF91: dw   0,   0 : db $AA, $0A, $00, $02

#_0DCF99: dw  -1,  -1 : db $BE, $0A, $00, $00
#_0DCFA1: dw   0,   0 : db $AA, $0A, $00, $02
#_0DCFA9: dw   0, -10 : db $A8, $0A, $00, $02
#_0DCFB1: dw   0,   0 : db $AA, $0A, $00, $02

#_0DCFB9: dw  -1,  -1 : db $BE, $0A, $00, $00
#_0DCFC1: dw   0,   8 : db $BF, $0A, $00, $00
#_0DCFC9: dw   0, -10 : db $A8, $0A, $00, $02
#_0DCFD1: dw   0,   0 : db $AA, $0A, $00, $02
...
#_0DD008: dw   0,  -8 : db $C8, $06, $00, $02

#_0DD010: dw   0, -16 : db $E6, $06, $00, $02
#_0DD018: dw   0,  -8 : db $CA, $06, $00, $02

#_0DD020: dw   0, -16 : db $E8, $06, $00, $02
#_0DD028: dw   0,  -8 : db $CA, $06, $00, $02

#_0DD030: dw   0, -16 : db $CC, $00, $00, $02
#_0DD038: dw   0,  -8 : db $DC, $00, $00, $02
...
.oam_groups
#_0DD060: dw   0,  -3 : db $8B, $00, $00, $00
#_0DD068: dw   3,   0 : db $9B, $00, $00, $00
#_0DD070: dw  -3,   0 : db $8B, $C0, $00, $00
#_0DD078: dw   0,   3 : db $9B, $C0, $00, $00

#_0DD080: dw   0,  -5 : db $8A, $00, $00, $02
#_0DD088: dw   5,   0 : db $8A, $00, $00, $02
#_0DD090: dw  -5,   0 : db $8A, $00, $00, $02
#_0DD098: dw   0,   5 : db $8A, $00, $00, $02

#_0DD0A0: dw   0,  -7 : db $86, $00, $00, $02
#_0DD0A8: dw   7,   0 : db $86, $00, $00, $02
#_0DD0B0: dw  -7,   0 : db $86, $00, $00, $02
#_0DD0B8: dw   0,   7 : db $86, $00, $00, $02

#_0DD0C0: dw   0,  -9 : db $86, $80, $00, $02
#_0DD0C8: dw   9,   0 : db $86, $80, $00, $02
#_0DD0D0: dw  -9,   0 : db $86, $80, $00, $02
#_0DD0D8: dw   0,   9 : db $86, $80, $00, $02

#_0DD0E0: dw   0,  -9 : db $86, $C0, $00, $02
#_0DD0E8: dw   9,   0 : db $86, $C0, $00, $02
#_0DD0F0: dw  -9,   0 : db $86, $C0, $00, $02
#_0DD0F8: dw   0,   9 : db $86, $C0, $00, $02

#_0DD100: dw   0,  -7 : db $86, $40, $00, $02
#_0DD108: dw   7,   0 : db $86, $40, $00, $02
#_0DD110: dw  -7,   0 : db $86, $40, $00, $02
#_0DD118: dw   0,   7 : db $86, $40, $00, $02
...
.oam_groups
#_0DD142: dw  -8, -16 : db $8C, $00, $00, $02
#_0DD14A: dw   8, -16 : db $8C, $40, $00, $02
#_0DD152: dw  -8,   0 : db $AC, $00, $00, $02
#_0DD15A: dw   8,   0 : db $AC, $40, $00, $02

#_0DD162: dw  -8, -13 : db $8A, $00, $00, $02
#_0DD16A: dw   8, -13 : db $8A, $40, $00, $02
#_0DD172: dw  -8,   0 : db $AC, $00, $00, $02
#_0DD17A: dw   8,   0 : db $AC, $40, $00, $02

#_0DD182: dw  -8,  -8 : db $8A, $00, $00, $02
#_0DD18A: dw   8,  -8 : db $8A, $40, $00, $02
#_0DD192: dw  -8,   0 : db $AC, $00, $00, $02
#_0DD19A: dw   8,   0 : db $AC, $40, $00, $02

#_0DD1A2: dw  -8,  -4 : db $8A, $00, $00, $02
#_0DD1AA: dw   8,  -4 : db $8A, $40, $00, $02
#_0DD1B2: dw  -8,   0 : db $AA, $00, $00, $02
#_0DD1BA: dw   8,   0 : db $AA, $40, $00, $02

#_0DD1C2: dw  -8,   0 : db $AA, $00, $00, $02
#_0DD1CA: dw   8,   0 : db $AA, $40, $00, $02
#_0DD1D2: dw  -8,   0 : db $AA, $00, $00, $02
#_0DD1DA: dw   8,   0 : db $AA, $40, $00, $02
...
#_0DD223: dw   0, -10 : db $00, $0E, $00, $02
...
#_0DD253: dw   0, -10 : db $02, $0E, $00, $02
#_0DD25B: dw   0,   0 : db $06, $0C, $00, $02

#_0DD263: dw  -7,   2 : db $07, $0D, $00, $02
#_0DD26B: dw  -7,   2 : db $07, $0D, $00, $02
#_0DD273: dw  10,  12 : db $05, $8D, $00, $00
#_0DD27B: dw  10,   4 : db $15, $8D, $00, $00
#_0DD283: dw   0, -10 : db $00, $0E, $00, $02
#_0DD28B: dw   0,   0 : db $04, $0C, $00, $02

#_0DD293: dw  -7,   1 : db $07, $0D, $00, $02
#_0DD29B: dw  -7,   1 : db $07, $0D, $00, $02
#_0DD2A3: dw  10,  13 : db $05, $8D, $00, $00
#_0DD2AB: dw  10,   5 : db $15, $8D, $00, $00
#_0DD2B3: dw   0,  -9 : db $00, $0E, $00, $02
#_0DD2BB: dw   0,   1 : db $04, $4C, $00, $02

#_0DD2C3: dw  -7,   8 : db $05, $8D, $00, $00
#_0DD2CB: dw   1,   8 : db $06, $8D, $00, $00
#_0DD2D3: dw   0, -10 : db $02, $0E, $00, $02
#_0DD2DB: dw  -6,  -1 : db $07, $4D, $00, $02
#_0DD2E3: dw   0,   0 : db $23, $0C, $00, $02
#_0DD2EB: dw   0,   0 : db $23, $0C, $00, $02

#_0DD2F3: dw  -9,   7 : db $05, $8D, $00, $00
#_0DD2FB: dw  -1,   7 : db $06, $8D, $00, $00
#_0DD303: dw   0,  -9 : db $02, $0E, $00, $02
#_0DD30B: dw  -6,   0 : db $07, $4D, $00, $02
#_0DD313: dw   0,   1 : db $25, $0C, $00, $02
#_0DD31B: dw   0,   1 : db $25, $0C, $00, $02

#_0DD323: dw -10, -17 : db $07, $0D, $00, $02
#_0DD32B: dw  15, -12 : db $15, $8D, $00, $00
#_0DD333: dw  15,  -4 : db $05, $8D, $00, $00
#_0DD33B: dw   0, -28 : db $08, $0E, $00, $02
#_0DD343: dw  -8, -19 : db $20, $0C, $00, $02
#_0DD34B: dw   8, -19 : db $20, $4C, $00, $02

#_0DD353: dw   0, -28 : db $08, $0E, $00, $02
#_0DD35B: dw   0, -28 : db $08, $0E, $00, $02
#_0DD363: dw  -8, -19 : db $20, $0C, $00, $02
#_0DD36B: dw   8, -19 : db $20, $4C, $00, $02
#_0DD373: dw  -8, -19 : db $20, $0C, $00, $02
#_0DD37B: dw   8, -19 : db $20, $4C, $00, $02
...
.oam_groups
#_0DD3EB: dw   4,   0 : db $27, $00, $00, $00
#_0DD3F3: dw   0,  -5 : db $0E, $00, $00, $02
#_0DD3FB: dw  -8,   6 : db $0A, $04, $00, $02
#_0DD403: dw   8,   6 : db $0A, $44, $00, $02
#_0DD40B: dw  -8,  14 : db $0A, $84, $00, $02
#_0DD413: dw   8,  14 : db $0A, $C4, $00, $02

#_0DD41B: dw   0,  -5 : db $0E, $00, $00, $02
#_0DD423: dw   0,  -5 : db $0E, $00, $00, $02
#_0DD42B: dw  -8,   6 : db $0A, $04, $00, $02
#_0DD433: dw   8,   6 : db $0A, $44, $00, $02
#_0DD43B: dw  -8,  14 : db $0A, $84, $00, $02
#_0DD443: dw   8,  14 : db $0A, $C4, $00, $02

#_0DD44B: dw   0,  -5 : db $2E, $00, $00, $02
#_0DD453: dw   0,  -5 : db $2E, $00, $00, $02
#_0DD45B: dw  -8,   7 : db $0A, $04, $00, $02
#_0DD463: dw   8,   7 : db $0A, $44, $00, $02
#_0DD46B: dw  -8,  14 : db $0A, $84, $00, $02
#_0DD473: dw   8,  14 : db $0A, $C4, $00, $02
...
.oam_groups
#_0DD4BC: dw   0,   0 : db $C6, $40, $00, $02
#_0DD4C4: dw   0,   0 : db $C6, $40, $00, $02

#_0DD4CC: dw   0,   0 : db $C4, $40, $00, $02
#_0DD4D4: dw   0,   0 : db $C4, $40, $00, $02

#_0DD4DC: dw   0,   0 : db $C6, $00, $00, $02
#_0DD4E4: dw   0,   0 : db $C6, $00, $00, $02

#_0DD4EC: dw   0,   0 : db $C4, $00, $00, $02
#_0DD4F4: dw   0,   0 : db $C4, $00, $00, $02

#_0DD4FC: dw  -8,   0 : db $C0, $00, $00, $02
#_0DD504: dw   8,   0 : db $C0, $40, $00, $02

#_0DD50C: dw  -8,   0 : db $C2, $00, $00, $02
#_0DD514: dw   8,   0 : db $C2, $40, $00, $02

#_0DD51C: dw  -8,   0 : db $E0, $00, $00, $02
#_0DD524: dw   8,   0 : db $E0, $40, $00, $02

#_0DD52C: dw  -8,   0 : db $E2, $00, $00, $02
#_0DD534: dw   8,   0 : db $E2, $40, $00, $02

#_0DD53C: dw  -8,   0 : db $E4, $00, $00, $02
#_0DD544: dw   8,   0 : db $E4, $40, $00, $02

#_0DD54C: dw   0,   0 : db $E6, $40, $00, $02
#_0DD554: dw   0,   0 : db $E6, $40, $00, $02

#_0DD55C: dw   0,   0 : db $E6, $00, $00, $02
#_0DD564: dw   0,   0 : db $E6, $00, $00, $02
...
.oam_groups
#_0DD58E: dw -11,   0 : db $9B, $01, $00, $00
#_0DD596: dw   0,  -8 : db $9B, $C1, $00, $00
#_0DD59E: dw   6,   6 : db $9B, $41, $00, $00

#_0DD5A6: dw -15,  -6 : db $8A, $01, $00, $02
#_0DD5AE: dw  -4, -14 : db $8A, $01, $00, $02
#_0DD5B6: dw   2,   0 : db $8A, $01, $00, $02

#_0DD5BE: dw -15,  -6 : db $86, $01, $00, $02
#_0DD5C6: dw  -4, -14 : db $86, $01, $00, $02
#_0DD5CE: dw   2,   0 : db $86, $01, $00, $02

#_0DD5D6: dw  -4,  -4 : db $86, $01, $00, $02
#_0DD5DE: dw  -4,  -4 : db $86, $01, $00, $02
#_0DD5E6: dw  -4,  -4 : db $86, $01, $00, $02

#_0DD5EE: dw  -4,  -4 : db $AA, $01, $00, $02
#_0DD5F6: dw  -4,  -4 : db $AA, $01, $00, $02
#_0DD5FE: dw  -4,  -4 : db $AA, $01, $00, $02
...
#_0DD687: JSL Ancilla_CheckDamageToSprite_preset

#_0DD68B: PLX
#_0DD68C: PLY

#_0DD68D: LDA.b #$0F
#_0DD68F: STA.w $0EA0,Y

#_0DD692: LDA.w $0D50,X
#_0DD695: ASL A
#_0DD696: STA.w $0F40,Y

#_0DD699: LDA.w $0D40,X
#_0DD69C: ASL A
#_0DD69D: STA.w $0F30,Y

#_0DD6A0: INC.w $0DA0,X
...
.oam_groups
#_0DD6A6: dw   0,   0 : db $C8, $00, $00, $02
#_0DD6AE: dw   0,   0 : db $C8, $00, $00, $02

#_0DD6B6: dw   0,   0 : db $CA, $00, $00, $02
#_0DD6BE: dw   0,   0 : db $CA, $00, $00, $02

#_0DD6C6: dw  -8,   0 : db $CC, $00, $00, $02
#_0DD6CE: dw   8,   0 : db $CC, $40, $00, $02

#_0DD6D6: dw  -8,   0 : db $CE, $00, $00, $02
#_0DD6DE: dw   8,   0 : db $CE, $40, $00, $02
...
.tongue_char
#_0DD73A: db $EE, $FD, $ED, $FD, $EE, $FD, $ED, $FD

.tongue_flip
#_0DD742: db $00, $00, $00, $40, $40, $C0, $80, $80
...
.loot_char
#_0DD83F: db $6E, $6F, $7E, $7F
#_0DD843: db $63, $7C, $73, $7C
#_0DD847: db $0B, $7C, $1B, $7C
#_0DD84B: db $EC, $F9, $FC, $F9
#_0DD84F: db $EA, $EB, $FA, $FB
...
.oam_groups
#_0DD8AF: dw  -8,  -8 : db $80, $00, $00, $02
#_0DD8B7: dw   8,  -8 : db $82, $00, $00, $02
#_0DD8BF: dw  -8,   8 : db $A0, $00, $00, $02
#_0DD8C7: dw   8,   8 : db $A2, $00, $00, $02

#_0DD8CF: dw  -7,  -7 : db $80, $00, $00, $02
#_0DD8D7: dw   7,  -7 : db $82, $00, $00, $02
#_0DD8DF: dw  -7,   7 : db $A0, $00, $00, $02
#_0DD8E7: dw   7,   7 : db $A2, $00, $00, $02

#_0DD8EF: dw  -7,  -7 : db $84, $00, $00, $02
#_0DD8F7: dw   7,  -7 : db $86, $00, $00, $02
#_0DD8FF: dw  -7,   7 : db $A4, $00, $00, $02
#_0DD907: dw   7,   7 : db $A6, $00, $00, $02

#_0DD90F: dw  -8,  -8 : db $84, $00, $00, $02
#_0DD917: dw   8,  -8 : db $86, $00, $00, $02
#_0DD91F: dw  -8,   8 : db $A4, $00, $00, $02
#_0DD927: dw   8,   8 : db $A6, $00, $00, $02
...
.char
#_0DD96F: db $AC, $AC, $AA, $8C
#_0DD973: db $8C, $8C, $AA, $AC
#_0DD977: db $AC, $AA, $AA, $8C
#_0DD97B: db $8C, $8C, $AA, $AC

.flip
#_0DD97F: db $40, $40, $40, $00
#_0DD983: db $00, $00, $00, $00
#_0DD987: db $80, $80, $80, $80
#_0DD98B: db $80, $80, $C0, $C0
...
.clear_next
#_0DFDA1: STA.l $7EC742,X

#_0DFDA5: DEX
#_0DFDA6: DEX
#_0DFDA7: BPL .clear_next
...
;===================================================================================================
NULL_0DFFC1:
#_0DFFC1: db $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
#_0DFFC9: db $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
#_0DFFD1: db $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
#_0DFFD9: db $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF

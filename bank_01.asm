...
.unused
#_01D9CA: dw $0000, $FFFE, $FF80, $FF7E
#_01D9D2: dw $0000, $0000, $FF80, $FF80
#_01D9DA: dw $0000, $FFFE, $0000, $FFFE

;---------------------------------------------------------------------------------------------------

.tile_01d9e0
#_01D9E2: dw $5252 ; hammer pegs
#_01D9E4: dw $5050 ; pots
#_01D9E6: dw $5454
#_01D9E8: dw $0000
#_01D9EA: dw $2323
...
.not_hammer_pegs
#_01DB16: CMP.w #$1010
#_01DB19: BNE FAIL_01DAB6

#_01DB1B: STY.w $042C

#_01DB1E: LDA.w $0540,Y
#_01DB21: JSR RevealPotItem

#_01DB24: LDY.w $042C

#_01DB27: JSR RoomDraw_16x16Single
#_01DB2A: JSR ManipBlock_Something
...
#_01DB37: LDA.b #$01
#_01DB39: JSL Sprite_SpawnImmediatelySmashedTerrain

#_01DB3D: JML AncillaAdd_BushPoof
...
.reveal_tile
#_01E71E: CMP.w #$0088
#_01E721: BEQ .reveal_switch

#_01E723: LDX.b $06

#_01E725: LDA.l $7F2000,X
#_01E729: AND.w #$000F
#_01E72C: ASL A
#_01E72D: TAY

#_01E72E: LDA.w $0500,Y
#_01E731: AND.w #$000F
#_01E734: ASL A
#_01E735: STA.b $00
...
#_01E74D: LDX.w #obj05BA-RoomDrawObjectData

.draw_next
#_01E750: LDA.l RoomDrawObjectData+0,X
#_01E754: STA.w $0560,Y

#_01E757: LDA.l RoomDrawObjectData+2,X
#_01E75B: STA.w $0580,Y

#_01E75E: LDA.l RoomDrawObjectData+4,X
#_01E762: STA.w $05A0,Y

#_01E765: LDA.l RoomDrawObjectData+6,X
#_01E769: STA.w $05C0,Y
...
#_01E77C: LDA.w #$0D0B
#_01E77F: STA.w $0560,Y

#_01E782: LDA.w #$0D1B
#_01E785: STA.w $0580,Y

#_01E788: LDA.w #$4D0B
#_01E78B: STA.w $05A0,Y

#_01E78E: LDA.w #$4D1B
#_01E791: STA.w $05C0,Y
...
.replacement_tiles
#_01E795: dw obj00E0-RoomDrawObjectData ; 0x00 - Floor
#_01E797: dw obj0ADE-RoomDrawObjectData ; 0x02 - Spike
#_01E799: dw obj05AA-RoomDrawObjectData ; 0x04 - Pit
#_01E79B: dw obj0198-RoomDrawObjectData ; 0x06 - Under the linoleum
#_01E79D: dw obj0210-RoomDrawObjectData ; 0x08 - Freezor hole left
#_01E79F: dw obj0218-RoomDrawObjectData ; 0x0A - Freezor hole right
#_01E7A1: dw obj1F3A-RoomDrawObjectData ; 0x0C - Warp
#_01E7A3: dw obj0EAA-RoomDrawObjectData ; 0x0E - Pressure switch up
#_01E7A5: dw obj0EB2-RoomDrawObjectData ; 0x10 - Pressure switch down
#_01E7A7: dw obj0140-RoomDrawObjectData ; 0x12 - Trinexx Ice
...
#_01E7F9: LDA.l .replacement_tiles,X
#_01E7FD: TAY

#_01E7FE: LDX.w $1000

#_01E801: LDA.w RoomDrawObjectData+0,Y
#_01E804: STA.w $1006,X

#_01E807: LDA.w RoomDrawObjectData+2,Y
#_01E80A: STA.w $100C,X

#_01E80D: LDA.w RoomDrawObjectData+4,Y
#_01E810: STA.w $1012,X

#_01E813: LDA.w RoomDrawObjectData+6,Y
#_01E816: STA.w $1018,X

#_01E819: LDX.b $06

#_01E81B: LDA.w RoomDrawObjectData+0,Y
#_01E81E: STA.l $7E2000,X

#_01E822: LDA.w RoomDrawObjectData+2,Y
#_01E825: STA.l $7E2080,X

#_01E829: LDA.w RoomDrawObjectData+4,Y
#_01E82C: STA.l $7E2002,X

#_01E830: LDA.w RoomDrawObjectData+6,Y
#_01E833: STA.l $7E2082,X

#_01E837: AND.w #$03FF
#_01E83A: TAX

#_01E83B: LDA.l $7EFE00,X
#_01E83F: AND.w #$00FF
#_01E842: STA.b $08
#_01E844: STA.b $09
...
#_01E84A: LDA.b $08
#_01E84C: STA.l $7F2000,X
#_01E850: STA.l $7F2040,X
...
#_01E857: LDA.w #$0000
#_01E85A: JSR .draw_one_corner
#_01E85D: STA.w $1002,X

#_01E860: LDA.w #$0080
#_01E863: JSR .draw_one_corner
#_01E866: STA.w $1008,X

#_01E869: LDA.w #$0002
#_01E86C: JSR .draw_one_corner
#_01E86F: STA.w $100E,X

#_01E872: LDA.w #$0082
#_01E875: JSR .draw_one_corner
#_01E878: STA.w $1014,X

#_01E87B: LDA.w #$0100
#_01E87E: STA.w $1004,X
#_01E881: STA.w $100A,X
#_01E884: STA.w $1010,X
#_01E887: STA.w $1016,X

#_01E88A: LDA.w #$FFFF
#_01E88D: STA.w $101A,X
...
#_01EBF3: INX
#_01EBF4: INX
#_01EBF5: CPX.w #$01F8 ; !HARDCODED table size
#_01EBF8: BEQ .no_chest_found

#_01EBFA: LDA.l RoomData_ChestItems,X
#_01EBFE: AND.w #$7FFF

#_01EC01: CMP.b $A0
#_01EC03: BNE .next_chest_check

#_01EC05: DEC.b $0E
#_01EC07: BNE .next_chest_check

;---------------------------------------------------------------------------------------------------

#_01EC09: LDA.l RoomData_ChestItems+2,X
#_01EC0D: STA.b $0C

#_01EC0F: LDA.l RoomData_ChestItems+0,X
#_01EC13: ASL A

#_01EC14: BCC .small_chest

#_01EC16: LDX.w $040C

#_01EC19: LDA.l $7EF366
#_01EC1D: AND.l DungeonMask,X
#_01EC21: BEQ .no_big_key_for_big_chest

#_01EC23: PLX
#_01EC24: PLA

#_01EC25: JMP.w OpenBigChest
...
#_01EC2B: LDA.w #$007A ; MESSAGE 007A
#_01EC2E: STA.w $1CF0

#_01EC31: SEP #$30

#_01EC33: JSL Interface_PrepAndDisplayMessage
...
#_01EC3B: LDA.w $0402
#_01EC3E: ORA.w RoomFlagMask,Y
#_01EC41: STA.w $0402

#_01EC44: LDY.w #obj14A4-RoomDrawObjectData

#_01EC47: LDA.w RoomDrawObjectData+0,Y
#_01EC4A: STA.l $7E2000,X
#_01EC4E: STA.b $02

#_01EC50: LDA.w RoomDrawObjectData+2,Y
#_01EC53: STA.l $7E2080,X
#_01EC57: STA.b $04

#_01EC59: LDA.w RoomDrawObjectData+4,Y
#_01EC5C: STA.l $7E2002,X
#_01EC60: STA.b $06

#_01EC62: LDA.w RoomDrawObjectData+6,Y

;---------------------------------------------------------------------------------------------------

.save_tile_map
#_01EC65: STA.l $7E2082,X
#_01EC69: STA.b $08
...
#_01EC71: LDA.w $06E0,Y
#_01EC74: CMP.w #$8000
#_01EC77: BCC .not_a_lock
...
#_01EC80: LDA.b $00
#_01EC82: STA.l $7F2000,X
#_01EC86: STA.l $7F2040,X
...
#_01EC8D: LDA.w #$0000
#_01EC90: JSR RoomTag_BuildChestStripes
#_01EC93: STA.w $1002,X

#_01EC96: LDA.w #$0080
#_01EC99: JSR RoomTag_BuildChestStripes
#_01EC9C: STA.w $1008,X

#_01EC9F: LDA.w #$0002
#_01ECA2: JSR RoomTag_BuildChestStripes
#_01ECA5: STA.w $100E,X

#_01ECA8: LDA.w #$0082
#_01ECAB: JSR RoomTag_BuildChestStripes
#_01ECAE: STA.w $1014,X

;---------------------------------------------------------------------------------------------------

#_01ECB1: LDA.b $02
#_01ECB3: STA.w $1006,X

#_01ECB6: LDA.b $04
#_01ECB8: STA.w $100C,X

#_01ECBB: LDA.b $06
#_01ECBD: STA.w $1012,X

#_01ECC0: LDA.b $08
#_01ECC2: STA.w $1018,X

#_01ECC5: LDA.w #$0100
#_01ECC8: STA.w $1004,X
#_01ECCB: STA.w $100A,X
#_01ECCE: STA.w $1010,X
#_01ECD1: STA.w $1016,X

#_01ECD4: LDA.w #$FFFF
#_01ECD7: STA.w $101A,X
...
#_01ECE8: JSL Underworld_FlagRoomData_Quadrants

;---------------------------------------------------------------------------------------------------

#_01ECEC: LDA.w $012F
#_01ECEF: BNE .skip_sfx

#_01ECF1: LDA.b #$0E ; SFX3.0E
#_01ECF3: STA.w $012F
...
.window_direction
#_01EF34: dw $FFFF, $FFFF, $FFFF, $0001
#_01EF3C: dw $FFFF, $FFFF, $FFFF, $0001
#_01EF44: dw $FFFF, $FFFF, $FFFF, $0001
#_01EF4C: dw $FFFF, $FFFF, $FFFF, $0001
...
#_01EF8E: JSL AdjustWaterHDMAWindow
...
.next_a
#_01EFB3: LDX.w $06B8,Y

#_01EFB6: LDA.w #$1D1D ; TILETYPE 1D
#_01EFB9: STA.l $7F2041,X
#_01EFBD: STA.l $7F2081,X
...
.no_props_to_edit
#_01EFC8: LDX.w $04AE
#_01EFCB: BEQ .exit_trigger_advance

#_01EFCD: LDY.w #$0000

.next_b
#_01EFD0: LDX.w $06EC,Y

#_01EFD3: LDA.w #$1D1D ; TILETYPE 1D
#_01EFD6: STA.l $7F2041,X
#_01EFDA: STA.l $7F2081,X
...
.next_a
#_01F243: LDX.w $06B8,Y

#_01F246: LDA.w #$0003 ; TILETYPE 03, TILETYPE 00
#_01F249: STA.l $7F2000,X

#_01F24D: XBA
#_01F24E: STA.l $7F2002,X

#_01F252: LDA.w #$0A03 ; TILETYPE 03, TILETYPE 0A
#_01F255: STA.l $7F3000,X

#_01F259: XBA
#_01F25A: STA.l $7F3002,X

#_01F25E: LDA.w #$0808 ; TILETYPE 08
#_01F261: STA.l $7F2040,X
#_01F265: STA.l $7F2042,X
#_01F269: STA.l $7F3040,X
#_01F26D: STA.l $7F3042,X

#_01F271: STA.l $7F3080,X
#_01F275: STA.l $7F3082,X
#_01F279: STA.l $7F30C0,X
#_01F27D: STA.l $7F30C2,X
...
.next_b
#_01F290: LDX.w $06EC,Y

#_01F293: LDA.w #$0003 ; TILETYPE 03, TILETYPE 00
#_01F296: STA.l $7F20C0,X

#_01F29A: XBA
#_01F29B: STA.l $7F20C2,X

#_01F29F: LDA.w #$0A03 ; TILETYPE 03, TILETYPE 0A
#_01F2A2: STA.l $7F30C0,X

#_01F2A6: XBA
#_01F2A7: STA.l $7F30C2,X

#_01F2AB: LDA.w #$0808 ; TILETYPE 08
#_01F2AE: STA.l $7F2080,X
#_01F2B2: STA.l $7F2082,X
#_01F2B6: STA.l $7F3000,X
#_01F2BA: STA.l $7F3002,X

#_01F2BE: STA.l $7F3040,X
#_01F2C2: STA.l $7F3042,X
#_01F2C6: STA.l $7F3080,X
#_01F2CA: STA.l $7F3082,X
...
.offset
#_01F7F1: dw $0004, $0008, $000C, $0010
#_01F7F9: dw $0014, $0018, $001C, $0020
#_01F801: dw $0100, $0200, $0300, $0400
#_01F809: dw $0500, $0600, $0700, $0800
...
#_01F9A2: CMP.w #$00A4
#_01F9A5: BNE .draw_solid_floor

;---------------------------------------------------------------------------------------------------

.draw_hole
#_01F9A7: LDY.w #obj05AA-RoomDrawObjectData
#_01F9AA: LDA.w RoomDrawObjectData+0,Y
#_01F9AD: STA.l $7E2080,X
#_01F9B1: STA.l $7E2082,X
#_01F9B5: STA.l $7E2084,X
#_01F9B9: STA.l $7E2086,X
#_01F9BD: STA.l $7E2100,X
#_01F9C1: STA.l $7E2102,X
#_01F9C5: STA.l $7E2104,X
#_01F9C9: STA.l $7E2106,X

#_01F9CD: LDY.w #obj063C-RoomDrawObjectData
#_01F9D0: LDA.w RoomDrawObjectData+2,Y
#_01F9D3: STA.l $7E2000,X
#_01F9D7: STA.l $7E2002,X
#_01F9DB: STA.l $7E2004,X
#_01F9DF: STA.l $7E2006,X

#_01F9E3: LDY.w #obj0642-RoomDrawObjectData
#_01F9E6: LDA.w RoomDrawObjectData+2,Y
#_01F9E9: STA.l $7E2180,X
#_01F9ED: STA.l $7E2182,X
#_01F9F1: STA.l $7E2184,X
#_01F9F5: STA.l $7E2186,X
...
#_01F9FD: LDA.w RoomDrawObjectData+0,Y
#_01FA00: STA.l $7E2000,X
#_01FA04: STA.l $7E2004,X
#_01FA08: STA.l $7E2100,X
#_01FA0C: STA.l $7E2104,X

#_01FA10: LDA.w RoomDrawObjectData+2,Y
#_01FA13: STA.l $7E2002,X
#_01FA17: STA.l $7E2006,X
#_01FA1B: STA.l $7E2102,X
#_01FA1F: STA.l $7E2106,X

#_01FA23: LDA.w RoomDrawObjectData+8,Y
#_01FA26: STA.l $7E2080,X
#_01FA2A: STA.l $7E2084,X
#_01FA2E: STA.l $7E2180,X
#_01FA32: STA.l $7E2184,X

#_01FA36: LDA.w RoomDrawObjectData+10,Y
#_01FA39: STA.l $7E2082,X
#_01FA3D: STA.l $7E2086,X
#_01FA41: STA.l $7E2182,X
#_01FA45: STA.l $7E2186,X
